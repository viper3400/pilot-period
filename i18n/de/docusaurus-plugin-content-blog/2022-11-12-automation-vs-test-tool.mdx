...
In der Diskussion über das richtige Framework oder Tool für die automatische Durchführung von
Tests für Webapplikationen kommt es in Diskussionen oft zu einem hitzigen
Schlagabtausch. Bezeichnend dafür ist, dass es dann häufig um die technischen
